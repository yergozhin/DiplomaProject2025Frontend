<template>
  <div class="dashboard-container" :style="{ backgroundImage: `url(${ploBackgroundImage})` }">
    ...
    <div class="sidebar" :class="{ 'sidebar-open': isSidebarOpen, 'sidebar-closed': !isSidebarOpen }">
      ...
      <div class="sidebar-content">
        <ul>
          ...
          <li>
            <router-link :to="ROUTES.PLO_EVENTS" active-class="active">
              Events
            </router-link>
          </li>
          <li>
            <router-link :to="ROUTES.PLO_AVAILABLE_FIGHTS" active-class="active">
              Available Fights
            </router-link>
          </li>
          <li>
            <router-link :to="ROUTES.PLO_OFFERS" active-class="active">
              Offers
            </router-link>
          </li>
          <li>
